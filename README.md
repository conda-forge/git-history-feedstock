...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/git-history-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14965&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/git-history-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `git-history` can be installed with:

```
conda install git-history
```

It is possible to list all of the versions of `git-history` available on your platform with:
